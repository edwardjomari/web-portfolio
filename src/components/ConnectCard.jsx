    ...
    return (
        <div className="col-span-1 bg-white dark:bg-[#1e1e1e] rounded-3xl p-6 lg:p-5 border border-gray-200 dark:border-[#2a2a2a] shadow-sm opacity-90 hover:opacity-100 transition-all ease-out duration-300 transform hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3">
                <a href="#" className="flex items-center gap-2 text-sm font-medium bg-transparent hover:bg-blue-600 dark:hover:bg-emerald-600 hover:text-white px-3 py-2 rounded-full transition-all duration-300 border border-gray-300 dark:border-[#3a3a3a] text-gray-800 dark:text-gray-200">
